...
setup(
    ...
    version=version,
    description=(
        "PyFVCOM is a collection of various tools which can be used to generate inputs files and interact "
        "with FVCOM outputs."
    ),
    author='Pierre Cazenave',
    author_email='pica@pml.ac.uk',
    url='https://gitlab.ecosystem-modelling.pml.ac.uk/fvcom/PyFVCOM',
    download_url=f'http://gitlab.em.pml.ac.uk/fvcom/PyFVCOM/repository/archive.tar.gz?ref={version}',
